...
local knownParams = {
	...
	--	{ Value,		"writepid",						"/var/run/openvpn.pid",											translate("Write process ID to file") },
		...
		{ DynamicList,	"ignore_unknown_option",		{ "VAR1 value1", "VAR2 value2" },								translate("Pass environment variables to script") },
...
--		{ Flag,			"ifconfig_pool_linear",			0,																translate("Use individual addresses rather than /30 subnets"),	{ server_mode="1" } }, -- deprecated and replaced by --topology p2p
	...
	{ "Cryptography", {
		...
		{ Value,		"tls_auth",						"/etc/openvpn/tlsauth.key 1",									translate("Additional authentication TLS") },
		{ FileUpload,	"tls_crypt",			   	    "/etc/openvpn/ta.key",											translate("Uploaded TLS crypt key") },
